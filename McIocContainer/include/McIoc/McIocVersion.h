...
#define MC_IOC_PATCH 3 // version when you make backwards-compatible bug fixes.
#define MC_IOC_INTERNAL 3 // MC_IOC_INTERNAL version for perpurse like feature test, bug fix test,development, et
