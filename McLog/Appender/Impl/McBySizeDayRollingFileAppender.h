...
class MC_LOG_EXPORT McBySizeDayRollingFileAppender : public McSizeRollingFileAppender
{
    Q_OBJECT
    MC_FULL_DEFINE(McBySizeDayRollingFileAppender, McSizeRollingFileAppender)
    Q_PROPERTY(int day READ day WRITE setDay)
public:
    McBySizeDayRollingFileAppender() noexcept;
