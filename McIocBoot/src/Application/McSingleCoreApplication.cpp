...
MC_DECL_PRIVATE_DATA(McSingleCoreApplication)
...
McSingleCoreApplication::McSingleCoreApplication(int& argc, char** argv) noexcept
    : QGuiApplication(argc, argv)
{
    MC_NEW_PRIVATE_DATA(McSingleCoreApplication);
#ifndef QT_DEBUG
...
McSingleCoreApplication::~McSingleCoreApplication() noexcept 
{
}

bool McSingleCoreApplication::isRunning() noexcept 
{
    return d->isRunning;
}

void McSingleCoreApplication::setAppObj(QObject *obj) noexcept 
{
    d->mainApp = obj;
}

void McSingleCoreApplication::slot_newLocalConnection() noexcept 
{
...
void McSingleCoreApplication::initLocalConnection() noexcept 
{
    d->isRunning = false;
...
void McSingleCoreApplication::newLocalServer() noexcept 
{
...
void McSingleCoreApplication::activateWindow() noexcept 
{
    if(d->mainApp) {
