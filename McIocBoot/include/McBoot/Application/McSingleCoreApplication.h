...
MC_FORWARD_DECL_PRIVATE_DATA(McSingleCoreApplication);
 ...
 */
class MCIOCBOOT_EXPORT McSingleCoreApplication : public QGuiApplication 
{
    Q_OBJECT
public:
...
private:
    MC_DECL_PRIVATE(McSingleCoreApplication)
};
