...
#define MC_MINOR 5 // version when you make small feature changes.
#define MC_PATCH 0 // version when you make backwards-compatible bug fixes.
#define MC_INTERNAL 2 // MC_INTERNAL version for perpurse like feature test, bug fix test,development, et
