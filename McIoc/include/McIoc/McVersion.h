...
#define MC_MAJOR 1 // version when you make big feature changes.
#define MC_MINOR 4 // version when you make small feature changes.
#define MC_PATCH 0 // version when you make backwards-compatible bug fixes.
#define MC_INTERNAL 10 // MC_INTERNAL version for perpurse like feature test, bug fix test,development, et
